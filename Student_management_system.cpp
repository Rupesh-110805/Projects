...
public:
    Student(int stdId, string stdName, int stdAge, string contact, double attendance)
    {
        rollno = stdId;
        name = stdName;
        age = stdAge;
    ...
    void setAttendancePercentage(double attendance)
    {
        attendancePercentage = attendance;
    }
    ...
    for (int i = 0; i < students.size(); i++)
    {
        ...
        if (students[i].getName() == sname)
        {
            ...
            case 4:
            {
                ...
                students[i].setContactNumber(contact);
            ...
            case 5:
            {
                ...
                students[i].setAttendancePercentage(attendance);
...
void addNewStudent(vector<Student> &students)
{
    ...
    Student newStudent(rollno, name, age, contact, attendance);
...
main()
{
    ...
    students.push_back(Student(123, "Rupesh", 18, "7386367987", 90.00));
